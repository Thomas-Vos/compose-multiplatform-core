...
import androidx.wear.compose.material3.l10n.en
import androidx.wear.compose.material3.l10n.translationFor
...
internal actual value class Strings(val value: Int) {
    actual companion object {
        actual val SliderDecreaseIconContentDescription = Strings(0)
        actual val SliderIncreaseIconContentDescription = Strings(1)
        actual val AlertDialogContentDescriptionConfirmButton = Strings(2)
        actual val AlertDialogContentDescriptionDismissButton = Strings(3)
        actual val OpenOnPhoneContentDescriptionIcon = Strings(4)
    }
}
